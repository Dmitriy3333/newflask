...
class Sanatorium(db.Model):
    ...
    price_per_service = db.Column(db.Numeric(10, 2), nullable=True)
    country = db.Column(db.String(110), nullable=False)
    region = db.Column(db.String(100), nullable=False)
    resort = db.Column(db.String(100), nullable=False)
    place_to_attractions = db.Column(db.Integer, nullable=False)
    ...
    average_review_score = db.Column(db.Numeric(3, 1), nullable=True)
